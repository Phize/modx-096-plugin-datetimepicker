...
function Datepicker() {
	...
	this._defaults = { // Global    デフォルト：s for all the date picker instances
...
$.extend(Datepicker.prototype, {
	...
	/* Override the    デフォルト： settings for all instances of the date picker. 
	...
	_generateDatepicker: function(inst) {
		...
		var clear = (this._get(inst, 'mandatory') ? '' :
			'<div class="ui-datepicker-clear"><a onclick="modxPluginDatepicker.jQuery.datepicker._clearDate(\'#' + inst.id + '\');"' +
			(showStatus ? this._addStatus(inst, this._get(inst, 'clearStatus') || '&#xa0;') : '') + '>' +
			this._get(inst, 'clearText') + '</a></div>');
		var controls = '<div class="ui-datepicker-control">' + (isRTL ? '' : clear) +
			'<div class="ui-datepicker-close"><a onclick="modxPluginDatepicker.jQuery.datepicker._hideDatepicker();"' +
		...
		var prev = '<div class="ui-datepicker-prev">' + (this._canAdjustMonth(inst, -1, drawYear, drawMonth) ? 
			'<a onclick="modxPluginDatepicker.jQuery.datepicker._adjustDate(\'#' + inst.id + '\', -' + stepMonths + ', \'M\');"' +
		...
		var html = (prompt ? '<div class="' + this._promptClass + '">' + prompt + '</div>' : '') +
			...
			'<a onclick="modxPluginDatepicker.jQuery.datepicker._gotoToday(\'#' + inst.id + '\');"' +
			...
			for (var col = 0; col < numMonths[1]; col++) {
				...
				for (var dow = 0; dow < 7; dow++) { // days of the week
					...
					html += '<td' + ((dow + firstDay + 6) % 7 >= 5 ? ' class="ui-datepicker-week-end-cell"' : '') + '>' +
						(!changeFirstDay ? '<span' :
						'<a onclick="modxPluginDatepicker.jQuery.datepicker._changeFirstDay(\'#' + inst.id + '\', ' + day + ');"') + 
				...
				for (var dRow = 0; dRow < numRows; dRow++) { // create date picker rows
					...
					for (var dow = 0; dow < 7; dow++) { // create date picker days
						...
						html += '<td class="ui-datepicker-days-cell' +
							...
							(unselectable ? (highlightWeek ? ' onmouseover="modxPluginDatepicker.jQuery(this).parent().addClass(\'ui-datepicker-week-over\');"' + // highlight selection week
							' onmouseout="modxPluginDatepicker.jQuery(this).parent().removeClass(\'ui-datepicker-week-over\');"' : '') : // unhighlight selection week
							' onmouseover="modxPluginDatepicker.jQuery(this).addClass(\'ui-datepicker-days-cell-over\')' + // highlight selection
							(highlightWeek ? '.parent().addClass(\'ui-datepicker-week-over\')' : '') + ';' + // highlight selection week
							(!showStatus || (otherMonth && !showOtherMonths) ? '' : 'modxPluginDatepicker.jQuery(\'#ui-datepicker-status-' +
							inst.id + '\').html(\'' + (dateStatus.apply((inst.input ? inst.input[0] : null),
							[printDate, inst]) || '&#xa0;') +'\');') + '"' +
							' onmouseout="modxPluginDatepicker.jQuery(this).removeClass(\'ui-datepicker-days-cell-over\')' + // unhighlight selection
							(highlightWeek ? '.parent().removeClass(\'ui-datepicker-week-over\')' : '') + ';' + // unhighlight selection week
							(!showStatus || (otherMonth && !showOtherMonths) ? '' : 'modxPluginDatepicker.jQuery(\'#ui-datepicker-status-' +
							inst.id + '\').html(\'&#xa0;\');') + '" onclick="modxPluginDatepicker.jQuery.datepicker._selectDay(\'#' +
	...
	_generateMonthYearHeader: function(inst, drawMonth, drawYear, minDate, maxDate,
		...
		if (secondary || !this._get(inst, 'changeMonth'))
			...
			html += '<select class="ui-datepicker-new-month" ' +
				'onchange="modxPluginDatepicker.jQuery.datepicker._selectMonthYear(\'#' + inst.id + '\', this, \'M\');" ' +
				'onclick="modxPluginDatepicker.jQuery.datepicker._clickMonthYear(\'#' + inst.id + '\');"' +
		...
		if (secondary || !this._get(inst, 'changeYear'))
			...
			html += '<select class="ui-datepicker-new-year" ' +
				'onchange="modxPluginDatepicker.jQuery.datepicker._selectMonthYear(\'#' + inst.id + '\', this, \'Y\');" ' +
				'onclick="modxPluginDatepicker.jQuery.datepicker._clickMonthYear(\'#' + inst.id + '\');"' +
	...
	_addStatus: function(inst, text) {
		return ' onmouseover="modxPluginDatepicker.jQuery(\'#ui-datepicker-status-' + inst.id + '\').html(\'' + text + '\');" ' +
			'onmouseout="modxPluginDatepicker.jQuery(\'#ui-datepicker-status-' + inst.id + '\').html(\'&#xa0;\');"';
	},
